...
public class GetFilesFromAssetsTask extends AsyncTask<Void, String, List<File>>{
    ...
    private DocxConvertTest mDocxConvertSample;

    public GetFilesFromAssetsTask(DocxConvertTest docx, List<File> result, OutputListener outputLis, String FolderPath, String Ext)
    {
