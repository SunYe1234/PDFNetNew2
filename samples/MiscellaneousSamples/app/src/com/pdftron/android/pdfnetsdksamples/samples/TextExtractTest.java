        ...
        try {
            ...
            if (example4_advanced) {
                ...
                for (line = txt.getFirstLine(); line.isValid(); line = line.getNextLine()) {
                    ...
                    mOutputListener.println("<Line box=\"" + bbox.getX1() + ", " + bbox.getY1() + ", " + bbox.getX2() + ", " + bbox.getY2() + "\"");
                    ...
                    for (word = line.getFirstWord(); word.isValid(); word = word.getNextWord()) {
                        ...
                        bbox = word.getBBox();
                        mOutputListener.print("<Word box=\"" + bbox.getX1() + ", " + bbox.getY1() + ", " + bbox.getX2() + ", " + bbox.getY2() + "\"");
