	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            try {
                ...
                FileOutputStream fos = new FileOutputStream(Utils.createExternalFile("tiger_100dpi_rot90.raw").getAbsolutePath());
            ...
            try {
                ...
                draw.export(text_doc.getPageIterator().next(), Utils.createExternalFile(filename).getAbsolutePath());
            ...
            try {
                ...
                draw.export(separation_doc.getPage(1), Utils.createExternalFile(filename).getAbsolutePath(), "PNG");
                mOutputListener.println("Example 10 a): " + filename + ". Done.");

                filename = new String("separation");
                draw.export(separation_doc.getPage(1), Utils.createExternalFile(filename).getAbsolutePath(), "PNG", separation_hint);
                mOutputListener.println("Example 10 b): " + filename + "_[ink].png. Done.");

                filename = new String("separation_NChannel.tif");
                draw.export(separation_doc.getPage(1), Utils.createExternalFile(filename).getAbsolutePath(), "TIFF", separation_hint);
