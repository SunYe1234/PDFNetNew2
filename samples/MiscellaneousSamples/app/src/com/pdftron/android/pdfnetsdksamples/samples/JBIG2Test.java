...
public class JBIG2Test extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            pdf_doc.save(Utils.createExternalFile("US061222892_JBIG2.pdf").getAbsolutePath(), SDFDoc.SaveMode.REMOVE_UNUSED, null);
            mFileList.add(new File(pdf_doc.getFileName()).getName());
            pdf_doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
