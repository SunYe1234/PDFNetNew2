...
public class StamperTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex1.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex2.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex3.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            fish_doc.close();
            doc.close();
        } catch (Exception e) {
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex4.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex5.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex6.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            fish_doc.close();
            doc.close();
        } catch (Exception e) {
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex7.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename + ".ex8.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
