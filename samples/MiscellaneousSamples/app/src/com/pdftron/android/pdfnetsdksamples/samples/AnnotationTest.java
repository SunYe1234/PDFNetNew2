...
public class AnnotationTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            doc.save(Utils.createExternalFile("annotation_test1.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            ...
            doc.save(Utils.createExternalFile("annotation_test2.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            ...
            doc1.save(Utils.createExternalFile("new_annot_test_api.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc1.getFileName()).getName());
    ...
    static void AnnotationHighLevelAPI(PDFDoc doc) throws PDFNetException {
        ...
        com.pdftron.pdf.annots.FileAttachment file_attach = com.pdftron.pdf.annots.FileAttachment.create(doc, new Rect(80, 280, 200, 320), (Utils.getAssetTempFile(INPUT_PATH + "peppers.jpg").getAbsolutePath()));
