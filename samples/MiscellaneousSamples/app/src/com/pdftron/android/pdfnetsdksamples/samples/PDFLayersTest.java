...
public class PDFLayersTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            doc.save(Utils.createExternalFile("pdf_layers.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            ...
            if (doc.hasOC() == false) {
                ...
                if (ocgs != null) {
                    ...
                    for (i = 0; i < sz; ++i) {
                        ...
                        String fname = Utils.createExternalFile("pdf_layers_").getAbsolutePath() + ocg.getName() + ".png";
                        mOutputListener.println(fname);
                        pdfdraw.export(page, fname);
                        mFileList.add("pdf_layers_" + ocg.getName() + ".png");
                    }
                }
