...
public class BookmarkTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            doc.save((Utils.createExternalFile("bookmark.pdf").getAbsolutePath()), SDFDoc.SaveMode.NO_FLAGS, null);
        ...
        try {
            ...
            doc.save((Utils.createExternalFile("bookmark_remote.pdf").getAbsolutePath()), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
