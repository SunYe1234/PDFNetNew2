...
public class OptimizerTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename2).getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename3).getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            doc.save(Utils.createExternalFile(input_filename4).getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            doc.save(Utils.createExternalFile("TigerText_flatten.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            mFileList.add(new File(doc.getFileName()).getName());
            doc.close();
        } catch (Exception e) {
            e.printStackTrace();
