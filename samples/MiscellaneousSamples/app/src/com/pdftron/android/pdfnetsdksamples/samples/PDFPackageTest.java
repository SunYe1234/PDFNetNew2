...
public class PDFPackageTest extends PDFNetSample {
	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            addCoverPage(doc);
            doc.save(Utils.createExternalFile("package.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
        ...
        try {
            ...
            if (files.isValid()) {
                ...
                for (int counter = 0; i.hasNext(); i.next(), ++counter) {
                    ...
                    if (stm != null) {
                        String fname = Utils.createExternalFile("extract_").getAbsolutePath() + counter;
