 ...
 */
public class DocxConversionProgessTask extends AsyncTask<DocxConvertTest, String, Map<String,String>>
{
    ...
    private DocxConvertTest mSample;
    private OutputListener mLisener;

    public DocxConversionProgessTask(DocxConvertTest args, OutputListener lisener)
    {
    ...
    @Override
    protected Map<String,String> doInBackground(DocxConvertTest... args){
