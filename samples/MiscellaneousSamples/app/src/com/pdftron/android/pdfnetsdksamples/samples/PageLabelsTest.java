	...
	public void run(OutputListener outputListener) {
        ...
        try {
            ...
            //-----------------------------------------------------------
            {
                ...
                doc.save(Utils.createExternalFile("newsletter_with_pagelabels.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
            ...
            //-----------------------------------------------------------
            {
                ...
                doc.save(Utils.createExternalFile("newsletter_with_pagelabels_modified.pdf").getAbsolutePath(), SDFDoc.SaveMode.LINEARIZED, null);
                mFileList.add(new File(doc.getFileName()).getName());
