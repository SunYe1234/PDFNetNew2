...
public class ToolManagerBuilder implements Parcelable {
    ...
    private boolean showAnnotIndicator = true;
    ...
    public ToolManagerBuilder setStyle(Context context, @StyleRes int styleRes) {
        ...
        try {
            setEditInk(a.getBoolean(R.styleable.ToolManager_edit_ink_annots, editInk))
                ...
                .setDigitalSignatureKeystorePath(a.getString(R.styleable.ToolManager_digital_signature_keystore_path))
                .setDigitalSignatureKeystorePassword(a.getString(R.styleable.ToolManager_digital_signature_keystore_password))
     ...
     *
     * @param showSavedSignatures true if saved signature will show in signature dialog, false otherwise
     */
     ...
     *
     * @param showAnnotIndicator true if show indicator, false otherwise
     */
     ...
     *
     * @param showSignatureFromImage true if pick from image icon will show in signature dialog, false otherwise
     */
     ...
     *
     * @param annotationLayerEnabled true if annotation layer is enabled, false otherwise
     */
    ...
    public ToolManager build(@Nullable FragmentActivity activity, @NonNull PDFViewCtrl pdfViewCtrl) {
        ...
        toolManager.setShowAnnotIndicators(PdfViewCtrlSettingsManager.getShowAnnotationIndicator(context, showAnnotIndicator));
