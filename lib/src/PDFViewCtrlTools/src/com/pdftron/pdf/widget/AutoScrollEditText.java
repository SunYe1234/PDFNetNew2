...
public class AutoScrollEditText extends AppCompatEditText {
     ...
     * It invokes the auto scroll edit text listener onKeyUp event
     */
    @Override
    ...
    /**
     * Overload implementation of {@link android.widget.EditText#onKeyPreIme(int, KeyEvent)}
     * It invokes the auto scroll edit text listener onKeyPreIme event
     */
    @Override
