...
public class RecentViewFragment extends FileBrowserViewFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRecentFilesFetcher = new RecentFilesFetcher(getContext(), getRecentFilesManager());
    ...
    private void reloadFileInfoList() {
        ...
        mDisposables.add(
                mRecentFilesFetcher.getRecentFilesOnce()
    ...
    private static class RecentFilesFetcher {

        final Context mContext;
        final FileInfoManager mRecentFilesManager;

        private RecentFilesFetcher(Context context, FileInfoManager recentFilesManager) {
            mContext = context;
            mRecentFilesManager = recentFilesManager;
        }

        private Single<List<FileInfo>> getRecentFilesOnce() {
