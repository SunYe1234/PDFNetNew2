...
public class PopulateAllFilesTask extends CustomAsyncTask<Void, Void, Void> {
    ...
    private TreeSet<FileInfo> mFileInfoList;
    ...
    public PopulateAllFilesTask(
        ...
        mSortMode = sortMode;
        mFileInfoList = (sortMode == null) ? new TreeSet<FileInfo>() : new TreeSet<>(mSortMode);
    ...
    protected void onPreExecute(
        ...
        AnalyticsHandlerAdapter.getInstance().sendTimedEvent(AnalyticsHandlerAdapter.POPULATE_FILES_TASK);
    ...
    protected void onPostExecute(
        ...
        params.put("Number of Files", Integer.toString(mFileInfoList.size()));
        AnalyticsHandlerAdapter.getInstance().endTimedEvent(AnalyticsHandlerAdapter.POPULATE_FILES_TASK, params);
